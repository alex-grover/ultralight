...
export const categories: Category[] = [
  ...
  },
  {
    name: "Shelter",
    items: [
      { item: "tarp", name: "MYOG 6x9 silpoly", description: "", classification: "base", weight: 219.4, quantity: 1 },
  ...
  },
  {
    name: "Sleep",
    items: [
      { item: "quilt", name: "MYOG 3.6 Apex (45F)", description: "", classification: "base", weight: 464.8, quantity: 1 },
      { item: "pillow", name: "Exped Ultra", description: "", classification: "base", weight: 51, quantity: 1 },
      { item: "pad", name: "CCF, 6 panels", description: "", classification: "base", weight: 199, quantity: 1 },
    ],
  },
  {
    name: "Cooking",
    items: [
      ...
      { item: "jar", name: "20oz", description: "", classification: "base", weight: 69.3, quantity: 1 },
  ...
  },
  {
    ...
    items: [
      ...
      { item: "midlayer", name: "MYOG AD90 hoody", description: "", classification: "base", weight: 151.9, quantity: 1 },
  ...
  },
  {
    ...
    items: [
      ...
      { item: "tp", name: "1/2 roll + 2 ziplock bags", description: "", classification: "base", weight: 48.1, quantity: 1 },
      { item: "soap", name: "Bronners", description: "", classification: "consumable", weight: 11.1, quantity: 1 },
  ...
  },
  {
    name: "Misc",
    items: [
      { item: "first aid kit", name: "Ibuprofen, cetirizine, band aids", description: "", classification: "base", weight: 16.2, quantity: 1 },
      ...
      { item: "flashlight", name: "RovyVon A5", description: "", classification: "base", weight: 22, quantity: 1 },
      { item: "storage", name: "Gallon ziplock", description: "", classification: "base", weight: 8.5, quantity: 1 },
      { item: "cards", name: "ID, credit card, cash", description: "", classification: "base", weight: 12, quantity: 1 },
    ],
  },
  {
    name: "Clothing (Worn)",
    items: [
      { item: "shirt", name: "OR Echo", description: "", classification: "worn", weight: 147, quantity: 1 },
      { item: "pants", name: "Vuori Meta", description: "", classification: "worn", weight: 447.7, quantity: 1 },
      { item: "underwear", name: "Lululemon", description: "", classification: "worn", weight: 64.6, quantity: 1 },
  ...
  },
  {
    ...
    items: [
      ...
      { item: "water", name: "1L", description: "", classification: "consumable", weight: 1000, quantity: 1 },
      ...
      { item: "electrolytes", name: "Gatorade Zero packet", description: "", classification: "consumable", weight: 3.6, quantity: 2 },
    ],
  },
]
